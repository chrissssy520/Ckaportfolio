...
FROM daily ORDER BY order_date;`,
  },
  {
    ...
    description: "Next SQL project currently in progress. Will cover advanced joins, subqueries, and real-world dataset analysis.",
    tags: ["MySQL", "Joins", "Subqueries"],
    score: null,
    githubUrl: "https://github.com/chrissssy520",
    code: `-- Coming Soon
-- Next SQL project in progress...`,
  },
  {
    id: 3,
    title: "SQL Project 3",
    subtitle: "Coming Soon",
    description: "Upcoming SQL project focused on data cleaning, transformation, and exploratory data analysis using a new dataset.",
